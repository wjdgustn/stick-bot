...
module.exports = () => {
    const connect = () => {
        mongoose.connect(setting.MONGO_URL ? setting.MONGO_URL :`mongodb://${setting.MONGODB_USER}:${setting.MONGODB_PASSWORD}@${setting.MONGODB_HOST}:${setting.MONGODB_PORT}/admin`, setting.MONGO_URL ? {} : {
